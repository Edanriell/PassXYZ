...
public class ItemsTests : TestContext
{
	...
	private readonly PwGroup childGroup1;
	private readonly Mock<IDataStore<Item>> dataStore;
	private readonly PxEntry entry1;
	private readonly PxEntry entry2;
	private PxEntry entry3;
	private readonly PwGroup rootGroup;
	...
	public ItemsTests()
	{
		...
		dataStore.Setup(x => x.SetCurrentGroup(null)).Returns(rootGroup.Name);
	...
	public void Load_ChildGroup1_Success()
	{
		...
		dataStore.Setup(x => x.SetCurrentGroup(childGroup1)).Returns(childGroup1.Name);
		dataStore.Setup(x => x.GetItem(It.IsAny<string>())).Returns(childGroup1);

...
public static class PwDatabaseEx
{
	...
	private static readonly string[] jsonBanks =
	{
	...
	private static readonly string[] jsonBrokers =
	{
	...
	private static readonly string[] jsonInsurance =
	{
	...
	public static void CreateTestDb(PwDatabase pwDb)
	{
		...
		var gMoney = new PwGroup(true, true)
					 {
						 Name = "Money",
		...
		var gDeposits = new PwGroup(true, true)
						{
							Name = "Deposits",
		...
		var gInvestment = new PwGroup(true, true)
						  {
							  Name = "Investment",
							  Notes = "My investment"
						  };
		var gStocks = new PwGroup(true, true)
					  {
						  Name = "Stocks",
						  Notes = "My Stocks"
					  };
		...
		var gInsurance = new PwGroup(true, true)
						 {

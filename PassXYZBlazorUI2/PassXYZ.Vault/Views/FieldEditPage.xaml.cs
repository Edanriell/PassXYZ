...
public partial class FieldEditPage : ContentPage
{
	...
	private Item? _dataEntry;
	private readonly Action<string, string, bool> _updateAction;
    ...
    /// </summary>
    public FieldEditPage(Action<string, string, bool> updateAction, Item entry, string key = "", string value = "") :
		this(updateAction, key, value)
	{
		_dataEntry = entry;
	}
    ...
    /// </summary>
    public FieldEditPage(Action<string, string, bool> updateAction, string key, string value, bool isKeyVisible = false)
		: this(updateAction, key, value)
	{
		// This is the same as the another constructor, except this part
		if (isKeyVisible) keyField.IsVisible = true;
	}
	...
	{
		var isProtected = pwCheckBox.IsChecked;

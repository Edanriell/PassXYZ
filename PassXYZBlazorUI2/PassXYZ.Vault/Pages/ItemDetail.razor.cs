...
public partial class ItemDetail
{
	...
	private readonly string _dialogDeleteId = "deleteField";
	private readonly string _dialogEditId = "editField";
	private bool _isNewField;
	private readonly Field _newField;
	private readonly KeyValueData<Field> currentField;
	...
	public ItemDetail()
	{
		listGroupField = _newField = new Field("", "", false);
		currentField = new KeyValueData<Field>
					   {
						   Data = listGroupField
					   };

...
public partial class KeyValueView : ViewCell
{
	...
	public static readonly BindableProperty SourceProperty =
		BindableProperty.Create(nameof(Source), typeof(ImageSource), typeof(KeyValueView),
			propertyChanging: (bindable, oldValue, newValue) =>
			{
				var control = bindable as KeyValueView;
	...
	public static readonly BindableProperty ParentPageProperty =
		BindableProperty.Create(nameof(ParentPage), typeof(ContentPage), typeof(KeyValueView),
			propertyChanging: (bindable, oldValue, newValue) =>
			{
				var control = bindable as KeyValueView;
			});
	...
	{
		get => (ContentPage)GetValue(ParentPageProperty);
